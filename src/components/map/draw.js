import { along, lineSliceAlong, lineString, nearestPoint } from "@turf/turf";
...
export function DrawStuffOnMap(map = null, characters = {}) {
  ...
  function drawAnimatedRouteAndMarker(
    ...
    var alongLine = along(line, alongDistance, options);
    ...
    var marker = new mapboxgl.Marker(el)
      .setLngLat(alongLine.geometry.coordinates)
      .addTo(map);
  ...
  function animateMarker(
    ...
    // how far to move each frame in kms - calculate this based on distance
    ...
    marker.setLngLat(alongLine.geometry.coordinates).addTo(map);
  ...
  function addPopup(marker, person, distance, places, along) {
    ...
    var nearest = nearestPoint(targetpoint, places.places[0].data);
